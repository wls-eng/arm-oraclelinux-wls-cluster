...
function usage()
{
  echo_stderr "./setupClusterDomain.sh <wlsDomainName> <wlsUserName> <wlsPassword> <wlsServerName> <wlsAdminHost> <oracleHome> <storageAccountName> <storageAccountKey> <mountpointPath> <AppGWHostName>"
}
